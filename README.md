...
- **Android, iOS, macOS, Windows, Web** (single codebase)
- Clean Architecture
- Firebase stack (Auth, Firestore, Notifications, App Check)
- REST APIs, JSON data pipelines
...
- Virtual Production (Unreal + Aximmetry)  
- Corporate training simulations  

### Notable Projects
- **Multiplayer VR Demo for Volvo (Tracbel)** — real-time interaction for sales training  
